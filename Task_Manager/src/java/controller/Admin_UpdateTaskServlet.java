 ...
 * @author btfra
 */
@WebServlet(name = "Admin_UpdateTaskServlet", urlPatterns = {"/admin/submitTaskUpdate"})
public class Admin_UpdateTaskServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int taskID = Integer.parseInt(request.getParameter("taskID"));
                ...
                User_UpdateTaskQuery ut = new User_UpdateTaskQuery();
            ...
            Logger.getLogger(Admin_UpdateTaskServlet.class.getName()).log(Level.SEVERE, null, ex);
