 ...
 * @author btfra
 */
@WebServlet(name = "User_AddMyTasksServlet", urlPatterns = {"/user/addMyTask"})
public class User_AddMyTasksServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(User_AddMyTasksServlet.class.getName()).log(Level.SEVERE, null, ex);
