 ...
 * @author btfra
 */
@WebServlet(name = "User_UpdateTaskServlet", urlPatterns = {"/user/submitTaskUpdate"})
public class User_UpdateTaskServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(User_UpdateTaskServlet.class.getName()).log(Level.SEVERE, null, ex);
