 ...
 * @author Morgan
 */
@WebServlet(name = "Admin_DeleteMyTasksServlet", urlPatterns = {"/admin/deleteTask"})
public class Admin_DeleteMyTasksServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Admin_DeleteMyTasksServlet.class.getName()).log(Level.SEVERE, null, ex);
